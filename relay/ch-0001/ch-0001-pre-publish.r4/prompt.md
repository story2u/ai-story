...
- 只输出 `reviews/ch-0001.pre-publish.r4.md` 的完整 markdown 报告本体；不要寒暄，不要写文件，不要执行命令。
- 你可以且只能只读下列输入文件。
...
- `reviews/ch-0001.pre-publish.r2.md`（上轮参考）
- `relay/ch-0001/ch-0001-prose.r3/prompt.md`
- `relay/ch-0001/ch-0001-prose.r3/out.md`
- `relay/ch-0001/ch-0001-prose.r3/extracted.md`
- `relay/ch-0001/ch-0001-prose.r4/revision-brief.md`
- `relay/ch-0001/ch-0001-prose.r4/out.md`
- `relay/ch-0001/ch-0001-continuity.r3/out.md`
- `relay/ch-0001/ch-0001-continuity.r4/out.md`
- `relay/ch-0001/ch-0001-editorial.r4/out.md`

## 任务

对 ch-0001 prose r4 改写链做发布前轻量自检。重点：

1. 当前正文 provenance 是否为 `prose-writer@deepseek-v4-pro via opencode · ch-0001-prose.r4`。
2. continuity r4 与 editorial r4 是否均 pass，且 maker/checker 异模型成立（DeepSeek Pro 正文 → GPT 连续性 → Cursor 总编）。
3. r3 被打回后是否有落盘 revision-brief，r4 是否核销。
4. 章文件与 HANDOFF 账本是否同步到 r4。
5. 是否仍存在已知硬伤：青槐镇、七日、赵四、有意思了、五行驳杂。注意：这些词若只出现在 review 历史或 revision-brief 中作为问题记录，不算正文残留。
6. 如发现 opencode r4 直接 edit 文件的通道越权行为，标为 WARN；若 Showrunner 已复核且改动仅为 revision-brief 指定两处，不阻塞 pass。

## 输出格式

首行必须为 `VERDICT: pass | revise`，并包含 `ATTEMPT: r4`、`WARNINGS`、`BLOCKERS`、`REPORT: reviews/ch-0001.pre-publish.r4.md`。
